...
BEGIN TRANSACTION;
ALTER TABLE [Loan2] ADD [Status] nvarchar(max) NULL;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260228161532_Status', N'10.0.3');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260228162102_isDeleted', N'10.0.3');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260228163230_ISBNNew', N'10.0.3');
